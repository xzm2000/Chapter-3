...
public class Ch3Ex2Activity extends AppCompatActivity {
    ...
    private void resetTargetAnimation() {
        ...
        ObjectAnimator animator2X = ObjectAnimator.ofFloat(target, "scaleX",(float)1.0,(float)2.0);
        ...
        ObjectAnimator animator2Y = ObjectAnimator.ofFloat(target, "scaleY",(float)1.0,(float)2.0);
        ...
        ObjectAnimator animator3 = ObjectAnimator.ofFloat(target,"alpha",(float)1.0,(float)0.5);
